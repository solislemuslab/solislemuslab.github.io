...
missing: remove warnings so that they dont appear in html; debug both plots to make sure that it is plotting correctly, especially it seems that the last author label is not working.
...
missing: need to debug as it is not showing correctly where the co-authors are coming from
...
```{r, echo=FALSE}
plot_grid(p1v4,p2,p3,p4,ncol=2,nrow=2)
...
allpanels<-plot_grid(p1v4,panel2,ncol=2,rel_widths = c(1.5,2))
